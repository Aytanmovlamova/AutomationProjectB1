...
public class T5_drag_drop {
    ...
    public void drag_drop_test(){
        ...
        WebElement diveK = Driver.getDriver().findElement(By.xpath("//a[.=' 5000 ']"));
        WebElement debitAmount = Driver.getDriver().findElement(By.xpath("//ol[@id='amt7']"));

        action.dragAndDrop(diveK,debitAccount).perform();
        ...
        action.dragAndDrop(diveK, creditAmount).perform();
